...
func TestTrieInsertSearchDelete(t *testing.T) {
	...
	assert.True(t, hashTrie.Search("apple"), "Expected 'apple' to be in Trie")
	assert.True(t, hashTrie.Search("app"), "Expected 'app' to be in Trie")
	assert.True(t, hashTrie.Search("apricot"), "Expected 'apricot' to be in Trie")
	assert.False(t, hashTrie.Search("banana"), "Expected 'banana' not to be in Trie")
	assert.True(t, hashTrie.Search("batman"), "Expected 'batman' to be in Trie")
	assert.False(t, hashTrie.Search("batwoman"), "Expected 'batwoman' not to be in Trie")

	// 删除一个单词
	trie.Delete("apple")
	hashTrie.Delete("apple")

	// 重新检查单词是否存在
	assert.False(t, trie.Search("apple"), "Expected 'apple' not to be in Trie")
	assert.False(t, hashTrie.Search("apple"), "Expected 'apple' not to be in Trie")
}
